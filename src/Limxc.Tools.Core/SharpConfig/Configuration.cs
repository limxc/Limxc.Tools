...
namespace Limxc.Tools.Core.SharpConfig
{
    ...
    public class Configuration : IEnumerable<Section>
    {
        ...
        private static readonly Dictionary<Type, ITypeStringConverter> mTypeStringConverters;
        ...
        ///     When <paramref name="sectionName" /> or <paramref name="settingName" /> is null
        ///     or empty.
        /// </exception>
        ...
        internal static ITypeStringConverter FindTypeStringConverter(Type type)
        {
            ...
            if (!mTypeStringConverters.TryGetValue(type, out var converter))
                converter = FallbackConverter;

            return converter;
        }

        internal static ITypeStringConverter FallbackConverter { get; }
        ...
        /// </summary>
        public static char[] ValidCommentChars { get; }
