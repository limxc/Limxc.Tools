...
The drivers provided with this archive have been digitally signed, so they
work on Windows Vista or later without having to run in test mode.


INSTALLING
==========

  1. Open a command prompt in the i386 (32 bit) or x64 (64 bit)
     directory
  2. Run the command "setupc"
  3. Enter the install command, for example:
...
============
  ...
  1. Open a command prompt in the i386 (32 bit) or x64 (64 bit)
     directory
  2. Launch the Setup Command Prompt "setupc"
  3. Type "uninstall"
